...
public class StringUtils
{
	...
	public static String getId(String value) {
		...
		return value + sdf.format(new Date()) + getRandomFor5(math);
	}
	
	public static String getRandomFor5(String value) {
		String result = value;
		if (value.length() < 5) {
			String f = "";
	...
	public static final Date getNewDate() throws ParseException
	{
		String dateFormat = new String();
		...
		SimpleDateFormat formatter = new SimpleDateFormat (dateFormat,
				Locale.getDefault());
		String currentDateTime = formatter.format(new Date());
		Date dd=formatter.parse(currentDateTime);
		return dd;
	}
	...
	public static final int getIntDay(String date)throws Exception
	{
	...
	public static final int get24Hour(String date)throws Exception
	{
	...
	public static final int getIntMonth(String date)throws Exception
	{
